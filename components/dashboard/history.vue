<template>
  <div
    class="absolute top-[25%] left-1/2 transform -translate-x-1/2 -translate-y-[30%] flex flex-col"
  >
    <UContainer>
      ...
      >
        <UCard class="w-[1500px] flex-1" @click="() => handleDetail(index)">
          <div class="mb-[5px] flex flex-row">
            <h1 class="text-xl">
              <span class="font-bold">Type:</span> {{ history.type }}
            </h1>
          </div>
          <div class="mb-[5px]">
            <h1
              :class="click[index] === false ? 'truncate' : ''"
              class="text-xl"
            >
              <span class="font-bold">Input text :</span>
              {{ history.inputText }}
            </h1>
          </div>
          <div class="mb-[5px]">
            <h1
              ...
              class="text-xl"
            >
              <span class="font-bold">Output text:</span>
              {{ history.outputText }}
            </h1>
          </div>
          <div>
